...
if 1:
    ...
    desc += '-twilight';     dataset = EasyDict(tfrecord_dir='twilight', resolution=128); train.mirror_augment = False; kimg = 25665
    ...
    # Default options.
    train.total_kimg = kimg if kimg else 25000
...
if 0:
    ...
    train.total_kimg = kimg if kimg else train.total_kimg
